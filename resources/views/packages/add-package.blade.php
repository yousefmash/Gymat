	...
	<div class="modal-dialog modal-dialog-centered mw-750px">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				<!--begin::Modal title-->
				<h2 class="fw-bolder">إضافة باقة إشتراك جديدة</h2>
				<!--end::Modal title-->
			</div>
			<!--end::Modal header-->
			<!--begin::Modal body-->
			<div class="modal-body scroll-y mx-lg-5 my-7">
				<!--begin::Form-->
				<form id="add_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="post" action="{{ URL( Cookie::get('gym_name').'/package/store') }}">
					@csrf
					<!--begin::Scroll-->
									...
									<tbody class="text-gray-600 fw-bold">
										...
										<tr>
											...
											<td>
												<div class="d-flex">
													<label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
														<input class="form-control form-control-solid" type="text" value="" name="workout_days">
													</label>
												</div>
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												...
												<div class="d-flex">
													<!--begin::Checkbox-->
													<label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
														<input class="form-check-input" type="checkbox" value="1" name="bodybuilding">
													</label>
													<!--end::Checkbox-->
												</div>
												<!--end::Wrapper-->
										...
										<tr>
											...
											<td>
												...
												<div class="d-flex">
													<!--begin::Checkbox-->
													<label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
														<input class="form-check-input" type="checkbox" value="1" name="fitness">
													</label>
													<!--end::Checkbox-->
												</div>
												<!--end::Wrapper-->
										...
										<tr>
											...
											<td>
												...
												<div class="d-flex">
													<!--begin::Checkbox-->
													<label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
														<input class="form-check-input" type="checkbox" value="1" name="food_table">
													</label>
													<!--end::Checkbox-->
												</div>
												<!--end::Wrapper-->
										...
										<tr>
											...
											<td>
												...
												<div class="d-flex">
													<!--begin::Checkbox-->
													<label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
														<input class="form-control form-control-solid" type="text" value="" name="sauna">
													</label>
													<!--end::Checkbox-->
												</div>
												<!--end::Wrapper-->
										...
										<tr>
											...
											<td>
												...
												<div class="d-flex">
													<!--begin::Checkbox-->
													<label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
														<input class="form-control form-control-solid" type="text" value="" name="steam">
													</label>
													<!--end::Checkbox-->
												</div>
												<!--end::Wrapper-->
										...
										<tr>
											...
											<td>
												<!--begin::Checkbox-->
												<label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
													<textarea class="form-control form-control-solid rounded-3" name="note" rows="4"></textarea>												</label>
												<!--end::Checkbox-->
											</td>
											<!--end::Options-->
										</tr>
