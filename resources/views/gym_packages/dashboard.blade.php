				...
				<div class="card card-flush h-md-100">
					...
					<div class="card-body pt-1">
						...
						<div class="d-flex flex-column text-gray-600">
							...
							<div class="d-flex align-items-center py-2">
							<span class="bullet bg-primary me-3"></span>ملاحظات : {{ $p->note  }}</div>
						</div>
						<!--end::details-->
					</div>
					<!--end::Card body-->
					...
					<div class="card-footer flex-wrap pt-0">
						<a href="{{ url('admin/gym-package'.'/'.$p->id) }}" class="btn btn-light btn-active-primary my-1 me-2">تفاصيل الباقة</a>
...
@include('gym_packages.add-package')
...
<script>
	$(document).on("click", ".modal-class", function () {
	   ...
	   $("#lineitem").attr("action","gym-package/destroy/"+itemid)
	});
</script>
@endsection
