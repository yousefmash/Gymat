					...
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" id="sign_in_form" action="{{ route('login') }}" method="post">
							...
							<div class="text-center mb-10">
								<!--begin::Title-->
								<h1 class="text-dark mb-3">Sign In to <img alt="Logo" src="{{ asset("assets/media/logos/logo-dark.png")}}" class="h-40px" /></h1>
								<!--end::Title-->
							</div>
							<!--begin::Heading-->
							<!--begin::Input group-->
							...
							<div class="fv-row mb-10">
								...
								<div class="d-flex flex-stack mb-2">
									...
									<!--end::Label-->
									<!--begin::Link-->
									<a href="../../demo1/dist/authentication/layouts/basic/password-reset.html" class="link-secondary fs-6 fw-bolder">Forgot Password ?</a>
									<!--end::Link-->
								</div>
								<!--end::Wrapper-->
								<!--begin::Input-->
